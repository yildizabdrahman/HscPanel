            ...
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <h4 class="page-title">Group Düzenleme</h4>
                    </div>
                    <div class="col-8">
            ...
            <?php if ($message = session_flasdata('error')) { ?>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <i class="fa fa-table"></i> Group Edit
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <?php foreach ($languages as $key => $language) : $code = $language['code']; ?>
                                            <div class="tab-pane fade <?= $key == 0 ? "show active" : ""; ?>" id="pills-<?= $language['code']; ?>" role="tabpanel" aria-labelledby="pills-<?= $language['code']; ?>-tab">
                                                <input name="title[<?= $language['code']; ?>]" type="text" class="form-control" value="<?= $group['title']->$code; ?>">
                                            </div>
                            ...
                            <div class="form-group">
                                <label for="basic-input" class="col-sm-3 col-form-label">İzinler</label>
                                <div class="col-sm-12">

                                    <div class="row">

                                        <?php foreach (getPermissionURL() as $key =>  $url) : ?>

                                            <div class="col-lg-4 mb-3">
                                                <?= $url; ?> <input <?= in_array($key, $group['permissions']) ?  'checked' : ''; ?> name="permissions[<?= $key ?>]" type="checkbox" data-size="small" class="js-switch" data-color="#15ca20">
                                            </div>
                                        <?php endforeach; ?>
