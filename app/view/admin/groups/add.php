                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <?php foreach ($languages as $key => $language) : ?>
                                            <div class="tab-pane fade <?= $key == 0 ? "show active" : ""; ?>" id="pills-<?= $language['code']; ?>" role="tabpanel" aria-labelledby="pills-<?= $language['code']; ?>-tab">
                                                <input name="title[<?= $language['code']; ?>]" type="text" class="form-control" value="">
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <?php foreach (getPermissionURL() as $key =>  $url) : ?>
                                            ...
                                            <div class="col-lg-4 mb-3">
                                                <?= $url; ?> <input name="permissions[<?= $key ?>]" type="checkbox" data-size="small" class="js-switch" data-color="#15ca20">
                                            </div>
                                        <?php endforeach; ?>
